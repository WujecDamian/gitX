...
_It's type of app that could be written by AI in minutes, but I wanted to actually learn so I used AI as little as possible (mainly for asking some trivial questions about prisma etc.)_
